...
const TopNav = ({
  ...
  return (
    <div
      className="topnav-root border-b px-8 py-4 flex items-center justify-between sticky top-0 z-10 transition-colors duration-300"
      style={{ background: "var(--surface)", borderColor: "var(--border)" }}
    >
      {showSearch ? (
        <div className="topnav-search relative w-80">
